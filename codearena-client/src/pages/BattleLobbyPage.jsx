                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <nav className="hidden md:flex space-x-8 font-mono text-sm">
                            <a href="#" className="text-slate-500 hover:text-blue-600 transition-colors">./Practice</a>
                            <a href="#" className="text-blue-600 font-bold transition-colors">./Battle_Lobby</a>
