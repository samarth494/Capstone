...
const seedProblems = [
    ...
    examples: [
      {
        input: "(no input)",
        output: "Hello, World!",
        explanation: "Just print the string exactly.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    slug: "blind-coding",
    description:
      "Welcome to the Blind Coding Challenge! Support for C is enabled.\n\nWrite a program that reads an integer `n` and prints its square.\n\n### Input\nA single integer `n`.\n\n### Output\nThe square of `n`.",
    difficulty: "Medium",
    categories: ["Fundamentals"],
    ...
    examples: [{ input: "4", output: "16", explanation: "4 * 4 = 16" }],
  },
  {
    title: "Blind Coding: Factorial",
    slug: "blind-factorial",
    description:
      "In this blind challenge, you must compute the factorial of a given number `n`.\n\n### Task\nRead an integer `n` and print its factorial `n!`.\n\n### Constraints\n`0 <= n <= 10`",
    difficulty: "Medium",
    categories: ["Fundamentals"],
  ...
  {
    title: "Blind Coding: Sum of Digits",
    slug: "blind-sum-digits",
    description:
      "In this blind challenge, you must compute the sum of digits of a given number `n`.\n\n### Task\nRead a positive integer `n` and print the sum of its digits.\n\n### Constraints\n`1 <= n <= 10^9`",
    difficulty: "Easy",
    categories: ["Fundamentals"],
    tags: ["Math", "Competition"],
    xpReward: 80,
    templates: [
      {
        language: "c",
        code: "#include <stdio.h>\n\nint main() {\n    // Write your blind sum-of-digits solution here...\n\n    return 0;\n}",
      },
      {
        language: "python",
        code: "n = int(input())\n# Write blind solution below\n",
